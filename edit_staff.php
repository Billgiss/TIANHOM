...
<title>Edit Staff Information &ndash; Tianhom Scent Candle Store</title>
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Edit Information</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
        ...
        <div class="container">
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                	<div class="mb-4">
                       <form method="POST" action="edit_staff_db.php" id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form">
                       <?php if (isset($_SESSION['error'])): ?>
                        ...
                        <?php
                         $email = $_SESSION['email'];
                         $query = "SELECT staff_id, name, staff_email, staff_pwd FROM staff WHERE staff_email='$email'";
