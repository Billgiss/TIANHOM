...
<title>Edit Customer Information &ndash; Tianhom Scent Candle Store</title>
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Edit Account</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
        ...
        <div class="container">
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                	<div class="mb-4">
                       <form method="POST" action="edit_customer_db.php" id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form">
                       <?php if (isset($_SESSION['error'])): ?>
                        ...
                        <?php
                         $email = $_SESSION['email'];
                         $query = "SELECT customer_id, name, gender, email, address FROM customer WHERE email='$email'";
                        ...
                        ?>  
                          ...
                          <div class="row">
                            <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                <input type="submit" class="btn mb-3" value="Edit" name="edit_submit">
                                <p class="mb-4">
                                </p>
                            </div>
                         </div>
