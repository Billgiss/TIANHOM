...
<title>Create an Account &ndash; Tianhom Scent Candle Store</title>
        ...
        <div class="container">
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                	<div class="mb-4">
                       <form method="POST" action="register_db.php" id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form">
                       <?php if (isset($_SESSION['error'])): ?>
                          ...
                          <div class="row">
                            <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                <input type="submit" class="btn mb-3" value="Create" name="reg_submit">
                                <p class="mb-4">
									<a>Already have an account?</a> &nbsp; | &nbsp;
								    <a href="login.php" id="customer_register_link">Log in!</a>
                                </p>
                            </div>
                         </div>
                     </form>
