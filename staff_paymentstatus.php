    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Payment Status</h1>
                <table>
                <col width="15%">
                <col width="10%">
                <col width="10%">
                ...
                <tr> 
                    ...
                    <?php
                    $query = "SELECT order_table.order_id as order_id, customer.name as name, payment_status as status FROM order_table inner join customer WHERE order_table.customer_id = customer.customer_id";
                    ...
                    if (!empty($result)){
                        while($row=$result->fetch_array()){
                            ...
                            echo '<td><a href="status_db.php?orderid='.$row['order_id'].'">';
