...
<title>Thankyou &ndash; Tianhom Scent Candle Store</title>
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Thank you for purchasing!</h1>
            	...
            	<div class="footer-top">
                	<div class="row">
                    	<div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                            ...
                            <ul>
                            	<li><a href="shop.php">Instant</a></li>
                                <li><a href="shop.php">Drinks</a></li>
                                <li><a href="shop.php">Snacks</a></li>
                                <li><a href="shop.php">Household Products</a></li>
                                <li><a href="shop.php">Medicine</a></li>
                            </ul>
                        </div>
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
