    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Customer Information</h1>
                <table>
                <col width="15%">
                <col width="10%">
                <col width="10%">
                ...
                <tr> 
                    ...
                    $query = "SELECT name, gender, email, address FROM customer WHERE email='$email'";
                    ...
                    if ($result){
                        while($row=$result->fetch_array()){
                            ...
                            echo '<td><a href="edit_customer.php?email='. $row['email']. '">';
